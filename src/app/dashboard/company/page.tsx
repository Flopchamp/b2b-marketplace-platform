          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{user.name || 'Company Account'}</p>
              </div>
            </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg mb-6">
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-2">
              Welcome to DirectConnect! 🎉
            </h2>
            <p className="text-gray-600 mb-4">
              Your company account has been successfully created. Start building your product catalog and connecting with retailers.
            </p>
            {user.verificationStatus === 'pending' && (
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>Please complete your account verification to start selling on the platform.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <button className="relative group bg-white p-6 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 rounded-lg border border-gray-300 hover:border-blue-300 hover:shadow-md transition-all">
                ...
                <div className="mt-4">
                  <h3 className="text-lg font-medium text-gray-900">Browse Retailers</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Connect with retailers looking for your products
                  </p>
                </div>
                <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400 transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
